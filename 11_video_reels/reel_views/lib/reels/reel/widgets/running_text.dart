...
class RunningText extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Marquee(
      ...
      velocity: velocity,
      fadingEdgeStartFraction: fadingEdgeStartFraction ?? _defaultFadingEdgeStartFraction,
      fadingEdgeEndFraction: fadingEdgeEndFraction ?? _defaultFadingEdgeEndFraction,
    );
  }
}